/* global define */
define(['/bower_components/jquery/jquery', './services/soundSerice', './services/userService', './services/groupService','./controllers/sortableItemsCtrl'], function($, SoundService, UserService, GroupService, SortableItemsCtrl) {
	'use strict';
