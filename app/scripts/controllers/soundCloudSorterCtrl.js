/* global define */
define(['/bower_components/jquery/jquery', './services/pathService', './models/targetElements', './controllers/sortActionsCtrl'], function($, PathService, TargetElements, SortActionsCtrl) {
	'use strict';
